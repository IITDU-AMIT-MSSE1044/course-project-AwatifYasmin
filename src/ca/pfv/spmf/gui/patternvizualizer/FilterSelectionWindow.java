...
public class FilterSelectionWindow extends JDialog {
	 ...
	 */
	public FilterSelectionWindow(final Vector<String> columnNames,
			final Vector<Class> columnClasses, PatternTableRowFilters rowFilters, PatternVizualizer patternVisualizer) {
