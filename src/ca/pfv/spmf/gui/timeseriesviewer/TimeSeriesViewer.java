...
//		panelTools.setBounds(0, 0, 800, 100);
		...
		final JComboBox comboBoxLegend = new JComboBox(LegendFormat.values());
		comboBoxLegend.setBounds(416, 19, 87, 26);
		panelTools.add(comboBoxLegend);
		comboBoxLegend.setSelectedIndex(3);
		
		final JComboBox comboBoxSeriesLine = new JComboBox(new String[]{"NONE", "1 pts", "2 pts", "3 pts", "4 pts", "5 pts", "6 pts", "7 pts", "8 pts", "9 pts", "10 pts"});
		...
		final JComboBox comboBoxGrid = new JComboBox(new String[]{"VISIBLE", "NONE"});
		...
		final JComboBox comboBoxMarkers = new JComboBox(new String[]{"NONE", "1 pts", "2 pts", "3 pts", "4 pts", "5 pts", "6 pts", "7 pts", "8 pts", "9 pts", "10 pts"});
